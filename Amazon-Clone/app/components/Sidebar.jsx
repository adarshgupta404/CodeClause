...
const Sidebar = () => {
  ...
  console.log(user)
  return (
    <div className="w-[450px] h-[80vh] bg-white border shadow-sm rounded-xl py-5 relative xl:block hidden">
      ...
      <div className="absolute w-full mx-auto bottom-10">
        {user ? (
          <button className="flex items-center w-[85%] mx-auto space-x-2 text-xl uppercase text-white bg-black rounded-md justify-center py-2 px-4" onClick={Logout}>
            <span>
              <FiLogOut />
            </span>
            <span>logout</span>
